...
// });
const corsOptions = {
    origin: 'https://10.173.102.226:1482/index_all.html'
  }


  app.get('/myapp/acceptsuite/validateCustomer',cors(corsOptions),(req,resp,next) => {
  ...
  app.get('/myapp/acceptsuite/AcceptCustomer',cors(corsOptions),(req,resp,next)=> {
  ...
  app.get('/myapp/acceptsuite/AcceptHosted',cors(corsOptions),(req,resp,next) =>  {
  ...
  app.get('/myapp/acceptsuite/AcceptJs', cors(corsOptions),(req,resp,next) =>  {
